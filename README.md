...
| fadeFunction|||
| Should return a function that executes the fadeIn method on text associated with a specified selector & object. | elector, pizzaObject | ƒ () { $(selector).text(pizzaObject.cost).fadeIn(); }) |
